...
# LOADS DATA ---------------------------------------------
flat_sample = np.load("./Data/flat_sample_combined.npy")

final_params = np.load("./Data/final_params.npz")

just_params = final_params["pars"]
just_errs = final_params["errors"]

d_ch1 = np.load("./Data/ch1_data.npz")
d_ch2 = np.load("./Data/ch2_data.npz")
d_kepler = np.load("./Data/kepler_data.npz")
...
raw_data = np.load("./Data/additional_plotstuff.npz")
